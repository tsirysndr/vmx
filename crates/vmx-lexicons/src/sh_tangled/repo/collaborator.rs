...
impl<'a> Collaborator<'a> {
    pub fn uri(
        ...
        jacquard_common::types::uri::RecordUri<'a, CollaboratorRecord>,
...
impl<'a> ::jacquard_lexicon::schema::LexiconSchema for Collaborator<'a> {
    fn nsid() -> &'static str {
...
fn lexicon_doc_sh_tangled_repo_collaborator() -> ::jacquard_lexicon::lexicon::LexiconDoc<
    'static,
> {
    ::jacquard_lexicon::lexicon::LexiconDoc {
        lexicon: ::jacquard_lexicon::lexicon::Lexicon::Lexicon1,
        id: ::jacquard_common::CowStr::new_static("sh.tangled.repo.collaborator"),
        revision: None,
        description: None,
        defs: {
